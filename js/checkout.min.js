jQuery(function (e) {
	...
	var t = {
		...
		init_payment_methods: function () {
			...
			1 === o.length && o.eq(0).hide(), t.selectedPaymentMethod && e("#" + t.selectedPaymentMethod).prop("checked", !0), 0 === o.filter(":checked").length && o.eq(0).prop("checked", !0), o.filter(":checked").eq(0).trigger("click")
		},
		...
		payment_method_selected: function () {
			if (e(".payment_methods input.input-radio").length > 1) {
				var o = e("div.payment_box." + e(this).attr("ID"));
				e(this).is(":checked") && !o.is(":visible") && (e("div.payment_box").filter(":visible").slideUp(250), e(this).is(":checked") && e("div.payment_box." + e(this).attr("ID")).slideDown(250))
			...
			c !== t.selectedPaymentMethod && e(document.body).trigger("payment_method_selected"), t.selectedPaymentMethod = c
		},
		...
		update_checkout_action: function (o) {
			if (t.xhr && t.xhr.abort(), 0 !== e("form.checkout").length) {
				...
				var c = e("#billing_country").val(), i = e("#billing_state").val(),
					...
					h = n, p = a, l = u, _ = e(t.$checkout_form).find(".address-field.validate-required:visible"),
					f = !0;
				_.length && _.each(function () {
					"" === e(this).find(":input").val() && (f = !1)
				}), e("#ship-to-different-address").find("input").is(":checked") && (d = e("#shipping_country").val(), s = e("#shipping_state").val(), m = e("input#shipping_postcode").val(), h = e("#shipping_city").val(), p = e("input#shipping_address_1").val(), l = e("input#shipping_address_2").val());
				var g = {
				...
				e(".woocommerce-checkout-payment, .woocommerce-checkout-review-order-table").block({
					...
					success: function (o) {
						if (!0 !== o.reload) {
							...
							var c = e("#terms").prop("checked"), i = {};
							if (e(".payment_box input").each(function () {
									var t = e(this).attr("id");
									t && (-1 !== e.inArray(e(this).attr("type"), ["checkbox", "radio"]) ? i[t] = e(this).prop("checked") : i[t] = e(this).val())
								}), o && o.fragments && e.each(o.fragments, function (t, o) {
									e(t).replaceWith(o), e(t).unblock()
								}), c && e("#terms").prop("checked", !0), e.isEmptyObject(i) || e(".payment_box input").each(function () {
									var t = e(this).attr("id");
									t && (-1 !== e.inArray(e(this).attr("type"), ["checkbox", "radio"]) ? e(this).prop("checked", i[t]).change() : 0 === e(this).val().length && e(this).val(i[t]).change())
								}), "failure" === o.result) {
								var r = e("form.checkout");
								e(".woocommerce-error, .woocommerce-message").remove(), o.messages ? r.prepend('<div class="woocommerce-NoticeGroup woocommerce-NoticeGroup-updateOrderReview">' + o.messages + "</div>") : r.prepend(o), r.find(".input-text, select, input:checkbox").trigger("validate").blur(), t.scroll_to_notices()
							}
							t.init_payment_methods(), e(document.body).trigger("updated_checkout", [o])
